...
const buttonStyle = {
  ...
  function Cards() {
    ...
    const onCards = () => {
        navigate('/account/info/card');
    }

    const onLoan = () => {
        navigate('/account/info/loan');
    }

  return (
    <div className="container cards">
      <div className="card-row">
        <div className="card card-animation" onClick={onCards}>
          ...
          <div className="card-content">
            <Button style={buttonStyle} onClick={onCards}>My Cards</Button>
            <h3>Bank Card</h3>
            <p>Information About Your Bank Card.</p>
          </div>
        </div>
        <div className="card card-animation" onClick={onLoan}>
          <div className="card-image">
            <img
          ...
          <div className="card-content">
          <Button style={buttonStyle} onClick={onLoan}>My Loans</Button>
            <h3>Loans</h3>
            <p>Information About Your Active Loans.</p>
          </div>
        </div>
      </div>
    </div>
